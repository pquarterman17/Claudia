...
Status: **shipped**, in #44, #45, #47 and #48. Kept as the design record —
what was decided, what was deliberately left impossible, and the bug found
while writing it that had to be fixed before any of it could work.

Where the built thing diverged from this plan, the divergence is noted inline
below. Everything else landed as written.
